...
class HomeCategoryViewModel @Inject constructor(
    ...
    private val _category = MutableStateFlow<List<TVSeriesUiModel>>(emptyList())
    val category = _category.asStateFlow()
    fun loadCategory(genresId: Int) {
        viewModelScope.launch {
            _category.value = moviesRepository.getTVSeriesByGenreID(genresId)
        }
    }
}